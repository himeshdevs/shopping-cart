        ...
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt={product?.title} className="lg:w-1/2 w-full lg:h-auto max-h-[600px] h-64 object-contain object-center rounded" src={product?.image}/>
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <h2 className="text-sm title-font text-gray-700 tracking-widest uppercase">{product?.category}</h2>
              ...
              <div className="flex mb-4">
                <span className="flex items-center">
                  ...
                  <span className="text-gray-600 ml-3">1k + Reviews</span>
                </span>
              ...
              <div className="flex justify-between items-center">
                <span className="title-font font-medium text-2xl text-gray-900">Amount :${product?.price}</span>
                <div className=' flex'>
                  <button className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded mr-2" onClick={() => handleCart(product, true)}>Buy now</button>
